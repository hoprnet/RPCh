...
export const resultsOrParamsCmprVal = {
  0: "hash",
  1: "from",
  2: "to",
  3: "expiry",
...
export const resultsOrParamsValCmpr = {
  hash: 0,
  from: 1,
  to: 2,
  expiry: 3,
