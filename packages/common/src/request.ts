...
import { compressRpcRequest, decompressRpcRequest } from "./compression";
import {
...
export default class Request {
  ...
  public static async createRequest(
    ...
    const compressedBody = compressRpcRequest(body);
  ...
  public static async fromMessage(
    ...
    const body = decompressRpcRequest(compressedBody);
