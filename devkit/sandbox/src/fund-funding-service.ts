...
const {
  RPC_PROVIDER = process.env.FUNDING_HOPRD_API_ENDPOINT ?? "http://localhost:8545",
  FUNDING_HOPRD_API_ENDPOINT = process.env.FUNDING_HOPRD_API_ENDPOINT ?? "http://localhost:13301",
