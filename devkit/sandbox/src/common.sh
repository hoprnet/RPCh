...
start() {
    ...
    RESOLVED_HOPRD_API_ENDPOINT_1_EXT="https://$GROUP.hoprd.a.sandbox.rpch.tech"
    RESOLVED_HOPRD_API_ENDPOINT_2_EXT="https://$GROUP.hoprd.b.sandbox.rpch.tech"
    RESOLVED_HOPRD_API_ENDPOINT_3_EXT="https://$GROUP.hoprd.c.sandbox.rpch.tech"
    RESOLVED_HOPRD_API_ENDPOINT_4_EXT="https://$GROUP.hoprd.d.sandbox.rpch.tech"
    RESOLVED_HOPRD_API_ENDPOINT_5_EXT="https://$GROUP.hoprd.e.sandbox.rpch.tech"
