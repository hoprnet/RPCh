...
import { createCowSwapPayload, getMethodFromPayload, getStandardPayload } from "../utils/rpc-payload.js";
...
export class MockMetaMaskWallet extends MockWallet implements MockWallet {
    protected buildRequestBodies(): JsonRpcPayload[] {
        ...
        // cowswap-specific behavior (calling MULTICALL2_UNI)
        requests.push(...createCowSwapPayload());
